...
public class BoardCreator : MonoBehaviour
{
    ...
    Transform marker
    {
        get{
            ...
            {
                GameObject instance =
            Instantiate(tileSelectionIndicatorPrefab) as GameObject;
    ...
    Dictionary<Point, Tile2> tiles = new Dictionary<Point, Tile2>();
    ...
    Tile2 Create ()
    {
        ...
        return instance.GetComponent<Tile2>();
    }

    Tile2 GetOrCreate (Point p)
    {
    ...
    {
        Tile2 t = tiles.ContainsKey(pos) ? tiles[pos] : null;
